				...
				<div class="container-fluid">
                 ...
                 ?><option value="<?php echo $rowss['condname'] ; ?>" ><?php echo $rowss['condname']; ?></option>
                                ...
                                <?php } ?>
									...
									<input type="text" class="form-control" placeholder="Enter author name" name="aname">
									<br>

									<input type="text" class="form-control" placeholder="Enter publisher name" name="pname">
									<br> 
