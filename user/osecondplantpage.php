...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
  ...
  <body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2>Shop For Indore Plants & Seed</h2>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="row">
          <?php
                 $stmts = $admin -> ret("SELECT * FROM `addproduct` WHERE `condname`='Indore'");
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img src="../admin/admincontroller/<?php echo $rows['image']; ?>" height="100px" width="300px" alt="">
                        </div>
                        <h2><a href="thirdbookpage.php?vid=<?php echo $rows['b_id']?>"><?php echo $rows['name']; ?></a></h2>
