            ...
            <div class="container">
                <div class="signup-content">
                    <form action="slogreg.php" method="POST" id="signup-form" class="signup-form">
                        <h2 class="form-title" style="color:white;">Register Here</h2>
                        ...
                        <div class="form-group">
                            ...
                            <span style="color:white" toggle="#password" class="zmdi zmdi-eye field-icon toggle-password"></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label style="color: white;" for="agree-term" class="label-agree-term"><span><span></span></span >I agree all statements in  <a href="#" class="term-service" style="color: white;" >Terms of service</a></label>
                        </div>
                    ...
                    <p class="loginhere" style="color:gainsboro;">
                        Have already registered ?then <a href="sellerlogin.php" class="loginhere-link" style="color:white;">Login here</a>
                    </p>
                </div>
            </div>
        </section>
