        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form action="index.php" method="POST" id="signup-form" class="signup-form">
                        <h2 class="form-title" style="color: white;">Create account</h2>
                        ...
                        <div class="form-group">
                            ...
                            <label for="agree-term" class="label-agree-term" style="color: white;"><span><span></span></span >I agree all statements in  <a href="#" class="term-service" style="color: wheat;">Terms of service</a></label>
                        </div>
                    ...
                    <p class="loginhere" style="color: lawngreen;">
                        Have already an account ? <a href="login.php" class="loginhere-link" style="color: white;">Login here</a>
                    </p>
                </div>
            </div>
        </section>
